...
# 6.12内核
# 修改补丁文件：将 q6 预留从 64MB (0x4000000) 改为 48MB (0x3000000)
#sed -i 's/0x4ab00000 0x0 0x4000000/0x4ab00000 0x0 0x3000000/g' target/linux/qualcommax/patches-6.12/0103-arm64-dts-ipq6018-add-reserved-memory-nodes.patch
